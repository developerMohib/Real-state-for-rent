...
const Testomonial = () => {
    ...
    <div className="space-y-2 text-center md:w-2/3 mx-auto">
		...
		<div className="grid items-center gap-4 xl:grid-cols-5">
			<div data-aos="fade-up-right" className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
			...
			<div data-aos="fade-up" data-aos-duration="3000" className="p-6 xl:col-span-3">
