        ...
        <div className="container p-6 mx-auto space-y-8">
          <div className="space-y-2 text-center md:w-2/3 mx-auto">
            ...
            <p className=" text-sm text-gray-600">
              Here are some listings displayed with the featured property
              shortcode, which you can use when you have some special properties
              to present
            </p>
          </div>
          <div
            ...
            <article className="flex flex-col bg-gray-50">
              ...
              <div className="flex flex-col flex-1 p-6">
                ...
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="text-xs tracking-wider uppercase hover:underline text-indigo-600"
                >
                  Convenire
                </a>
